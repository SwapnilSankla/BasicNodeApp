...
console.log('This script populates some test getBooks, authors to your database. Specified database as argument - e.g.: populatedb mongodb+srv://cooluser:coolpassword@cluster0-mbdj7.mongodb.net/local_library?retryWrites=true');
...
function createBooks(cb) {
    async.parallel([
            ...
            function (callback) {
                bookCreate('Test Book 1', 'Summary of test getBook 1', 'ISBN111111', authors[4], callback);
            },
            function (callback) {
                bookCreate('Test Book 2', 'Summary of test getBook 2', 'ISBN222222', authors[4], callback)
            }
        ],
        // optional callback
        cb);
